          ...
          <div class="bg-surface-0 dark:bg-surface-900 p-6 shadow rounded-border">
            <div class="mb-2 flex items-center justify-between">
              <div class="flex items-center">
                ...
                <span class="text-xl font-medium text-surface-900 dark:text-surface-0">{{ $t('carriers.view.title')
                  }}</span>
              </div>
            </div>
            <div class="font-medium text-surface-500 dark:text-surface-300 mb-4">{{ $t('carriers.view.subtitle') }}
            </div>
            <div>
